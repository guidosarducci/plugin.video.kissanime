### ############################################################################################################
###	#	
### # Project: 			#		Config.py - by The Highway 2013-2015.
### # Author: 			#		The Highway
...
def ps(x):
	try:
		return {
			...
			,'GENRES': 							['Dub','Movie','Special','OVA','Music',
															 'Action','Adventure','Cars','Cartoon','Comedy',
															 'Dementia','Demons','Drama','Ecchi',
															 'Fantasy','Game',
															 'Harem','Historical','Horror',
															 'Josei','Kids',
															 'Magic','Martial Arts','Mecha',
															 'Military','Mystery',
															 'ONA','Parody','Police','Psychological',
			...
			,'rating.max': 										'10'
			,'cMI.history101.tv.remove.url': 	'XBMC.RunPlugin(%s?mode=%s&section=%s&title=%s&year=%s&img=%s&fanart=%s&country=%s&plot=%s&genre=%s&url=%s&dbid=%s&subfav=%s)'
			,'cMI.history101.tv.remove.name': 'Remove from History 101'
			,'cMI.history101.tv.remove.mode': 'RemoveVisit'
			,'cMI.history101.tv.empty.url': 	'XBMC.RunPlugin(%s?mode=%s&section=%s&title=%s&year=%s&img=%s&fanart=%s&country=%s&plot=%s&genre=%s&url=%s&dbid=%s&subfav=%s)'
			,'cMI.history101.tv.empty.name': 'Empty List - History 101'
			,'cMI.history101.tv.empty.mode': 'EmptyVisit'
